...
data Constant a b = Constant b  -- ?? pare gresita cerinta, trebuia sa aiba tipul Constant a
instance Functor (Constant a) where
  fmap f (Constant x) = Constant (f x)  -- o las asa desi e gresita
  -- trebuia sa fie fmap _ (Constant x) = Constant x dar e gresit declarat datatypeul; din documentatia haskell Functor.Constant :)
